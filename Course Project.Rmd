...
This document is the final report of the course project's Peer-graded Assignment from Coursera’s course *Practical Machine Learning*, as part of the *Data Science Specialization*. It was built up in RStudio, using the `knitr` package, meant to be published in html format.
...
```{r environment, cache=TRUE, message=FALSE, warning=FALSE}
...
```{r correlation, cache=TRUE, fig.height=9.25, fig.width=9.25}
...
```{r rf-plot,cache=TRUE, fig.height=6, fig.width=8}
# plot matrix results
...
```{r decision-trees, cache=TRUE, fig.height=8, fig.width=9.5}
# model fit
set.seed(12345)
...
```{r dt-plot,cache=TRUE, fig.height=6, fig.width=8}
# plot matrix results
...
```{r gbm-plot,cache=TRUE, fig.height=6, fig.width=8}
# plot matrix results
